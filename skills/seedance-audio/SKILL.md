...
Reliability is probabilistic and surface-dependent. In this Chinese-focused package, prefer short Mandarin lines, use a rights-cleared voice reference when the line matters, and budget retakes rather than promising a perfect voiced take. See `[ref:audio-guide]` for the field-observed Mandarin dialogue-capacity notes.
