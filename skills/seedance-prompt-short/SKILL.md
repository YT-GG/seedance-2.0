...
For Chinese compression, load `[skill:seedance-vocab-zh]` and `[ref:vocab/zh]`. Keep only wording that clarifies reference roles, dialogue, camera terms, or safe production constraints.
